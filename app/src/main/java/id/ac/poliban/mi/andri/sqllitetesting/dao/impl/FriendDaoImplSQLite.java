package id.ac.poliban.mi.andri.sqllitetesting.dao.impl;
...
import id.ac.poliban.mi.andri.sqllitetesting.dao.FriendDao;
import id.ac.poliban.mi.andri.sqllitetesting.domain.Friend;
...
//        getWritableDatabase().execSQL(sql, new Object[]{f.getId()});
//    }

    // error! dianggap bukan implementasi dari Interface FriendDao
    @Override
